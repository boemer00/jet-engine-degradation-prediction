...
# # Example usage:
# # Assuming X_train_scaled, y_train, X_test_scaled, y_test are already defined and scaled appropriately
# input_shape = (X_train_scaled.shape[1], X_train_scaled.shape[2])  # (timesteps, features)
# model = initialize_transformer_model(input_shape=input_shape)
# model, history = train_model(model, X_train_scaled, y_train, X_test_scaled, y_test, learning_rate=0.001)
